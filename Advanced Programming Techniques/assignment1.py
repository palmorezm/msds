...
def exercise03():
    ...
    sentence = 'understands how to code in python'
...
def exercise04():
    ...
    first_name = 'Zach'; last_name = 'Palmore'  
...
def exercise06():
    ...
    hours_worked = 20; wage_per_hour = 15; total_pay = hours_worked * wage_per_hour
...
def exercise07():
    # Create a variable wage and assign 17.0 to it. Print to the screen the datatype of wage. 
    # Create a second variable called doubled that prints to the screen 2 times wage
    # ------ Place code below here \/ \/ \/ ------

    wage = 17.0; print(type(wage)); doubled = 2 * wage
...
def exercise08():
    # Assign 5 to the variable quantity, 'hello' to the variable hello and 
    # a variable hello_repeated that holds a string that contains whatever 
    # is contained in the variable hello repeated quantity times

    # ------ Place code below here \/ \/ \/ ------

    quantity = 5; hello = 'hello'; hello_repeated = hello * 5
...
def exercise09():
    ...
    qty = 10; price = 5; total_cost = qty * price
...
def exercise10():
    # Create 5 variables named factorN where N is the numbers 1 to 5 and set them to 1 through 5, respectively. 
    # Create a variable called product that holds the product of the 5 variables

    # ------ Place code below here \/ \/ \/ ------

    factor1 = 1; factor2 = 2; factor3 = 3; factor4 = 4; factor5 = 5; product = (factor1 * factor2 * factor3 * factor4 * factor5)
...
def exercise11():
    ...
    pi = math.pi; pi = format(pi, '.10f')
    
    # to satisfy the requirement see below
    
    pi = 3.1415926535 # does not round last digit
...
def exercise13():
    # Create variables volume_sphere, r. Set r to 7 and calculate the volume of the sphere with r = 7 and 
    # assign it to volume_sphere

    # ------ Place code below here \/ \/ \/ ------

    pi = 3.14159; r = 7; volume_sphere = (4/3)*pi*r**3
...
def exercise14():
    # Create a variables area, length, height. Set length and height equal to 50 and 10.2 respectively. 
    # Assign area to the product of length and height, 
    # assign the variable area_type to the datatype of area

    # ------ Place code below here \/ \/ \/ ------
    
    length = 50; height = 10.2; area = length * height; area_type = type(area) 
...
def exercise15():
    ...
    speed_mph = 80; duration = 3; distance = speed_mph * duration
...
def exercise16():
    # Implement pythogorean thereom and find the length of hypotenuse c given sides a and b. 
    # Select any numbers for a and b. 
    # Use math.sqrt() for square root.

    # ------ Place code below here \/ \/ \/ ------

    a = 10; b  = 10; c = math.sqrt(a**2 + b**2) 
