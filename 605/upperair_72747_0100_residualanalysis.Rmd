...
This data was collected from a radiosonde during an upper air sounding at MPX in Chanhassen, MN on January 1. The data has been reduced to display only the variables on interest: ambient air pressure in hectopascals (hPa), radisonde height in meters (m), and the temperature at each point recorded in degrees Celcius (C). A sample of the data is shown below. 
