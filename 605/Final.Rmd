...
```{r}
# Observe statistics of each variable
describe(train)
```
...
```{r}
# Focus on preferred predictors
SalePrice, OverallCond, OverallQual, LotArea
train %>% 
  ggplot() + 
...
Kaggle username is "zacharypalmore" and my score is 
