# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 14:14:15 2021
...
# ‘steward’ variable) having an impacton the health of trees?
...
hue_order = ["Poor", "Fair", "Good", "Unknown"] # Set order (for later)
...
def update_bar_chart(boros):
    mask = df["boros"] == boros
    fig = px.bar(df[mask], x="count_tree_id", y="count_tree_id", 
